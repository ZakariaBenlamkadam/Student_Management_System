...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\pc\Desktop\tkinter\loginregis\loginRegistrationSystem\adminpage\assets\frame0")
...
managementButton = Button(image=button_image_6,borderwidth=0,highlightthickness=0,state=DISABLED,command=export_data,relief="flat")
managementButton.place(x=13.0,y=480.0,width=273.0,height=55.0)
